...
async function LoadPixi() {
    ...
    const talk0 = new Audio();
    const xhr1 = new XMLHttpRequest();
    const talk1 = new Audio();
    const xhr2 = new XMLHttpRequest();
    const talk2 = new Audio();
    const xhr3 = new XMLHttpRequest();
    const talk3 = new Audio();
    const xhr4 = new XMLHttpRequest();
    const talk4 = new Audio();
    xhr0.open('GET', './miyako/motions_talk_0_sound.ogg', true);
    xhr0.responseType = 'blob';
    xhr0.onload = function(){
        if (xhr0.status === 200){
            var blob = xhr0.response;
    ...
    xhr1.open('GET', './miyako/motions_talk_1_sound.ogg', true);
    ...
    xhr2.open('GET', './miyako/motions_talk_2_sound.ogg', true);
    ...
    xhr3.open('GET', './miyako/motions_talk_3_sound.ogg', true);
    xhr3.responseType = 'blob';
    xhr3.onload = function(){
        if (xhr3.status === 200){
            var blob = xhr3.response;
            var url = URL.createObjectURL(blob);
    ...
    xhr4.open('GET', './miyako/motions_talk_4_sound.ogg', true);
    xhr4.responseType = 'blob';
    xhr4.onload = function(){
        if (xhr4.status === 200){
            var blob = xhr4.response;
            var url = URL.createObjectURL(blob);
