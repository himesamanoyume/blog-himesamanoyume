...
async function LoadPixi() {
    ...
    const audio = new Audio('./miyako/CH0215_MemorialLobby_4_1.ogg');
    audio.volume = 0.4;
    const delayTime = 500; // 延迟时间（以毫秒为单位）
    ...
    function onAssetsLoaded(miyakoAsset) {
        ...
        miyako.state.addListener({
            start: trackEntry => {
                ...
                // console.log(`Animation ${trackEntry.animation.name} ended.`);
            ...
            complete: trackEntry => {
                ...
                if (trackEntry.animation.name === 'Talk_04_M') {
                    miyako.state.clearTrack(1)
                    app.stage.interactive = true;
                }
            }
        });
