...
async function LoadPixi() {
    ...
    const volume = 0.4
    const talk0 = new Audio('./miyako/motions_talk_0_sound.ogg');
    const talk1 = new Audio('./miyako/motions_talk_1_sound.ogg');
    const talk2 = new Audio('./miyako/motions_talk_2_sound.ogg');
    const talk3 = new Audio('./miyako/motions_talk_3_sound.ogg');
    const talk4 = new Audio('./miyako/motions_talk_4_sound.ogg');
    talk0.volume = volume;
    talk1.volume = volume;
    talk2.volume = volume;
    talk3.volume = volume;
