...
async function LoadPixi() {
    ...
    // PIXI.Assets.load('./miyako/CH0215_home.skel')
    ...
    function onAssetsLoaded(miyakoAsset) {
        ...
        // set current skin
        miyako.skeleton.setSlotsToSetupPose();

        // set the position
        miyako.x = app.renderer.width / 2;
        miyako.y = app.renderer.height;

        miyako.scale.set(0.5);
